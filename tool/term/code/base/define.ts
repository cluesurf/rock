 ...
 * JSX (in `.tool/term/layout.tsx`), sidebar is JSX (in
 * `.tool/term/sidebar.tsx`). Plugins / discovery / graph
 * abstractions are Phase 2 and live in their own modules.
 *
 *     // .term/workspace.ts
 *     import { defineWorkspace } from '@cluesurf/term'
 *
...
export type WorkspaceDefinition = {
   ...
   * directory that contains the `.tool/term/` folder.
   */
  root?: string
 ...
 * autocomplete to a `.tool/term/workspace.ts` export.
 *
...
/**
 * Named command map for `.tool/term/commands.ts`. Run via
 * `term run <name>` or the in-app command palette.
 *
 *     // .term/commands.ts
 *     import { defineCommands } from '@cluesurf/term'
 *
