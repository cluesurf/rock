...
// Decoration colors match the rock palette accent so the
...
export function Find({ controller }: FindProps) {
  ...
  return (
    <div data-rock-find="" role="search">
      <input
        ref={inputRef}
        data-rock-find-input=""
        type="text"
        placeholder="Find"
        value={query}
      ...
      <span data-rock-find-count="">{count}</span>
      <button
        data-rock-find-nav=""
        onClick={findPrev}
