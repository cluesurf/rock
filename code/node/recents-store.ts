/**
 * Global recents registry — projects Rock has launched.
 *
 * Lives at one well-known per-user path; not tied to any
 * specific project. Used to:
 *   - default `rock` (with no path arg) to the last
 *     opened project
 *   - power `rock list projects` / `rock recent`
...
export type RecentProject = {
  /** Path to the project root (the dir containing `.rock/`). */
  path: string
