...
printf '  HTTPS URL       https://github.com/cluesurf/rock\n'
...
printf '\n'
printf '  Absolute path   /Users/lancepollard/base/crew/cluesurf/deck/rock/readme.md\n'
printf '  Path with line  /Users/lancepollard/base/crew/cluesurf/deck/rock/code/face/dock.tsx:42\n'
printf '  Hidden dotfile  /Users/lancepollard/.zshrc\n'
printf '  Relative path   ./base/code/main.tsx\n'
printf '  Tilde path      ~/.config/rock/settings.json\n'
printf '\n'
printf '  Markdown-style  See [the docs](https://github.com/cluesurf/rock#readme)\n'
